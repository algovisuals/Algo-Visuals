          ...
          <div className=" text-xl text-gray-300 max-w-3xl mx-auto">
            <div className="relative inline-block">
              <motion.span
                ...
                initial={{
                  backgroundImage:
                    "linear-gradient(to right, rgb(0, 123, 255), rgb(0, 255, 128))",
                }}
                animate={{
                  backgroundImage:
                    "linear-gradient(to right, rgb(0, 255, 128), rgb(0, 123, 255))",
                }}
                transition={{
                  duration: 2,
                  repeat: Infinity,
            ...
            , Beautifully visualized algorithms through interactive
            demonstrations
          </div>
          ...
          <div className="mt-10">
            <div className="flex justify-center gap-4">
              ...
              <motion.button
                ...
                onClick={() =>
                  window.open(
                    "https://github.com/algovisuals/Algo-Visuals",
                    "_blank",
                  )
                }
