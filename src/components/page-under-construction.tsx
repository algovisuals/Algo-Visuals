      ...
      <section className="h-[60vh] flex flex-col items-center justify-center relative overflow-hidden">
        ...
        >
          ...
          <p className="mt-6 text-xl text-gray-300 max-w-2xl mx-auto">
            We&apos;re building this interactive visualization. Check back soon
            to explore this algorithm in detail.
          </p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-300">
                  We expect this visualization to be ready by June 2025. In the
                  meantime, explore our other available algorithms!
                </p>
              </div>
              ...
              <div className="border-t border-gray-600 pt-6">
                ...
                <p className="mt-4 text-gray-300">
                  Have suggestions or want to contribute? Contact the main
                  developer at:
                  <a
